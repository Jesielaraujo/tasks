/***************************************************************************
 *   ex4.cpp                                  Version 20221223.100529      *
 *                                                                         *
 *   Brief description                                                     *
 ...
 *   $ make ex4.xpp
 * ou
     $ g++ ex4.cpp libjda2.cpp -o  ex4.out

 *   $ g++ ex4.c -o ex4.xpp -Wall -Wextra -g -O0 -DDEBUG=1
 */
...
#define VERSION "20221223.100529" /* Version Number (string) */
#endif
...
{
    IFDEBUG("help()");
    /* printf("%s - %s\n", "ex4", "Brief description"); */
    cout << "ex4 - Brief description\n";
    cout << "\nUsage: ex4\n\n";
...
int main(void)
{
    ...
    doc.copyr();
     int n;
	cout << "digtite a quantidade de numeros para ser sorteaados"<<endl;
	cin >> n;
	sort *n2 = new sort();
	n2 ->lucky(n);
    /* ...and we are done */
